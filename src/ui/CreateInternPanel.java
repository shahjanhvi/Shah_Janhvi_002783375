...
public class CreateInternPanel extends javax.swing.JPanel {
 EmployeeProfileHistory employeeProfileHistory;
    ...
    /**
     * Creates new form CreateInternPanel
     */
    public CreateInternPanel(EmployeeProfileHistory employeeProfileHistory) {
        initComponents();
    ...
    private void saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveActionPerformed
        ...
        if(validation()){
            ...
            String gender = (String)drpGender.getSelectedItem();
             ...
             String jdate=sd.format(jDate.getDate());
           // StartDate startDate = txtStartDate.getStartDate();
